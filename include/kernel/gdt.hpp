...
namespace kernel::gdt
{
	...
	struct segment_descriptor_t
	{
		...
		struct system_access_byte_t : access_byte_t
		{
			...
			void set_segment_type(segment_type type);
		} __attribute__(packed);
